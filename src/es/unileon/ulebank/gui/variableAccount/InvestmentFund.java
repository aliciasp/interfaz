...
import es.unileon.ulebank.brokerage.InvestmentFoundPack;
...
public class InvestmentFund extends JFrame {
	...
	public InvestmentFund() {
		...
		variableAccount.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				VariableAccountWindow nextWindow = new VariableAccountWindow();
